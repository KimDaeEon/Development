...
PROTOBUF_CONSTEXPR S_LOGIN::S_LOGIN(
    ...
    /*decltype(_impl_.playercharacters_)*/{}
...
PROTOBUF_CONSTEXPR C_ENTER_GAME::C_ENTER_GAME(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.playercharacterindex_)*/uint64_t{0u}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
PROTOBUF_CONSTEXPR S_DESPAWN::S_DESPAWN(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.actorids_)*/{}
  , /*decltype(_impl_._actorids_cached_byte_size_)*/{0}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const uint32_t TableStruct_Protocol_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::S_LOGIN, _impl_.playercharacters_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::C_ENTER_GAME, _impl_.playercharacterindex_),
  ~0u,  // no _has_bits_
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::S_ENTER_GAME, _impl_.playercharacter_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::C_MOVE, _impl_.actorinfo_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_MOVE, _impl_.actorinfo_),
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::Protocol::S_DESPAWN, _impl_.actorids_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_Protocol_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "Struct.proto\"\t\n\007C_LOGIN\"I\n\007S_LOGIN\022\017\n\007su"
  "ccess\030\001 \001(\010\022-\n\020playerCharacters\030\002 \003(\0132\023."
  "Protocol.ActorInfo\",\n\014C_ENTER_GAME\022\034\n\024pl"
  "ayerCharacterIndex\030\001 \001(\004\"M\n\014S_ENTER_GAME"
  "\022\017\n\007success\030\001 \001(\010\022,\n\017playerCharacter\030\002 \001"
  "(\0132\023.Protocol.ActorInfo\"\016\n\014C_LEAVE_GAME\""
  "\016\n\014S_LEAVE_GAME\".\n\007S_SPAWN\022#\n\006actors\030\001 \003"
  "(\0132\023.Protocol.ActorInfo\"0\n\006C_MOVE\022&\n\tact"
  "orInfo\030\001 \001(\0132\023.Protocol.ActorInfo\"0\n\006S_M"
  "OVE\022&\n\tactorInfo\030\001 \001(\0132\023.Protocol.ActorI"
  "nfo\"\035\n\tS_DESPAWN\022\020\n\010actorIds\030\001 \003(\004\"\025\n\006C_"
  "CHAT\022\013\n\003msg\030\001 \001(\t\"&\n\006S_CHAT\022\017\n\007actorId\030\001"
...
const ::_pbi::DescriptorTable descriptor_table_Protocol_2eproto = {
    false, false, 545, descriptor_table_protodef_Protocol_2eproto,
    "Protocol.proto",
...
void S_LOGIN::clear_playercharacters() {
  _impl_.playercharacters_.Clear();
}
...
S_LOGIN::S_LOGIN(const S_LOGIN& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.playercharacters_){from._impl_.playercharacters_}
...
inline void S_LOGIN::SharedCtor(
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.playercharacters_){arena}
    , decltype(_impl_.success_){false}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}
...
inline void S_LOGIN::SharedDtor() {
  ...
  _impl_.playercharacters_.~RepeatedPtrField();
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_playercharacters(), ptr);
            CHK_(ptr);
...
uint8_t* S_LOGIN::_InternalSerialize(
  ...
  // repeated .Protocol.ActorInfo playerCharacters = 2;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_playercharacters_size()); i < n; i++) {
    const auto& repfield = this->_internal_playercharacters(i);
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_LOGIN)
  ...
  // repeated .Protocol.ActorInfo playerCharacters = 2;
  total_size += 1UL * this->_internal_playercharacters_size();
  for (const auto& msg : this->_impl_.playercharacters_) {
    total_size +=
...
void S_LOGIN::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.playercharacters_.MergeFrom(from._impl_.playercharacters_);
...
void S_LOGIN::InternalSwap(S_LOGIN* other) {
  ...
  _impl_.playercharacters_.InternalSwap(&other->_impl_.playercharacters_);
...
C_ENTER_GAME::C_ENTER_GAME(const C_ENTER_GAME& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.playercharacterindex_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _this->_impl_.playercharacterindex_ = from._impl_.playercharacterindex_;
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          _impl_.playercharacterindex_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* C_ENTER_GAME::_InternalSerialize(
  ...
  // uint64 playerCharacterIndex = 1;
  if (this->_internal_playercharacterindex() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(1, this->_internal_playercharacterindex(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.C_ENTER_GAME)
  ...
  // uint64 playerCharacterIndex = 1;
  if (this->_internal_playercharacterindex() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt64SizePlusOne(this->_internal_playercharacterindex());
  }
...
void C_ENTER_GAME::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_playercharacterindex() != 0) {
    _this->_internal_set_playercharacterindex(from._internal_playercharacterindex());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void C_ENTER_GAME::InternalSwap(C_ENTER_GAME* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  swap(_impl_.playercharacterindex_, other->_impl_.playercharacterindex_);
}
...
class S_ENTER_GAME::_Internal {
 public:
  static const ::Protocol::ActorInfo& playercharacter(const S_ENTER_GAME* msg);
};

const ::Protocol::ActorInfo&
S_ENTER_GAME::_Internal::playercharacter(const S_ENTER_GAME* msg) {
  return *msg->_impl_.playercharacter_;
}
void S_ENTER_GAME::clear_playercharacter() {
...
S_ENTER_GAME::S_ENTER_GAME(const S_ENTER_GAME& from)
  ...
  if (from._internal_has_playercharacter()) {
    _this->_impl_.playercharacter_ = new ::Protocol::ActorInfo(*from._impl_.playercharacter_);
  }
  _this->_impl_.success_ = from._impl_.success_;
...
uint8_t* S_ENTER_GAME::_InternalSerialize(
  ...
  if (this->_internal_has_playercharacter()) {
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, _Internal::playercharacter(this),
...
void S_ENTER_GAME::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_has_playercharacter()) {
    _this->_internal_mutable_playercharacter()->::Protocol::ActorInfo::MergeFrom(
...
void S_ENTER_GAME::InternalSwap(S_ENTER_GAME* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      - PROTOBUF_FIELD_OFFSET(S_ENTER_GAME, _impl_.playercharacter_)>(
          reinterpret_cast<char*>(&_impl_.playercharacter_),
          reinterpret_cast<char*>(&other->_impl_.playercharacter_));
}
...
class C_MOVE::_Internal {
 public:
  static const ::Protocol::ActorInfo& actorinfo(const C_MOVE* msg);
};

const ::Protocol::ActorInfo&
C_MOVE::_Internal::actorinfo(const C_MOVE* msg) {
  return *msg->_impl_.actorinfo_;
}
void C_MOVE::clear_actorinfo() {
...
class S_MOVE::_Internal {
 public:
  static const ::Protocol::ActorInfo& actorinfo(const S_MOVE* msg);
};

const ::Protocol::ActorInfo&
S_MOVE::_Internal::actorinfo(const S_MOVE* msg) {
  return *msg->_impl_.actorinfo_;
}
void S_MOVE::clear_actorinfo() {
  if (GetArenaForAllocation() == nullptr && _impl_.actorinfo_ != nullptr) {
    delete _impl_.actorinfo_;
  }
  _impl_.actorinfo_ = nullptr;
...
S_DESPAWN::S_DESPAWN(const S_DESPAWN& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.actorids_){from._impl_.actorids_}
    , /*decltype(_impl_._actorids_cached_byte_size_)*/{0}
    , /*decltype(_impl_._cached_size_)*/{}};
...
inline void S_DESPAWN::SharedCtor(
  ...
  (void)is_message_owned;
  new (&_impl_) Impl_{
      decltype(_impl_.actorids_){arena}
    , /*decltype(_impl_._actorids_cached_byte_size_)*/{0}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}
...
inline void S_DESPAWN::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.actorids_.~RepeatedField();
}
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::PackedUInt64Parser(_internal_mutable_actorids(), ptr, ctx);
          CHK_(ptr);
...
uint8_t* S_DESPAWN::_InternalSerialize(
  ...
  // repeated uint64 actorIds = 1;
  {
    int byte_size = _impl_._actorids_cached_byte_size_.load(std::memory_order_relaxed);
    if (byte_size > 0) {
...
// @@protoc_insertion_point(message_byte_size_start:Protocol.S_DESPAWN)
  ...
  // repeated uint64 actorIds = 1;
  {
    size_t data_size = ::_pbi::WireFormatLite::
      UInt64Size(this->_impl_.actorids_);
    if (data_size > 0) {
      total_size += 1 +
        ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
    }
    int cached_size = ::_pbi::ToCachedSize(data_size);
    _impl_._actorids_cached_byte_size_.store(cached_size,
...
void S_DESPAWN::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.actorids_.MergeFrom(from._impl_.actorids_);
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void S_DESPAWN::InternalSwap(S_DESPAWN* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  _impl_.actorids_.InternalSwap(&other->_impl_.actorids_);
}
...
uint8_t* S_CHAT::_InternalSerialize(
  ...
  if (this->_internal_actorid() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt64ToArray(1, this->_internal_actorid(), target);
  }
