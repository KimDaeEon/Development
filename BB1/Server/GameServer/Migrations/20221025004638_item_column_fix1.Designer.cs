...
namespace GameServer.Migrations
{
    ...
    [Migration("20221025004638_item_column_fix1")]
    partial class item_column_fix1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CSharpServer.DB.AccountDb", b =>
                {
            ...
            modelBuilder.Entity("CSharpServer.DB.ItemDb", b =>
                {
            ...
            modelBuilder.Entity("CSharpServer.DB.PlayerDb", b =>
                {
            ...
            modelBuilder.Entity("CSharpServer.DB.ItemDb", b =>
                {
                    b.HasOne("CSharpServer.DB.PlayerDb", "Owner")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("CSharpServer.DB.PlayerDb", b =>
                {
                    b.HasOne("CSharpServer.DB.AccountDb", "Account")
                        .WithMany("Players")
